...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //  Service Route
    Route::get('/services', [SliderController::class, 'index']);
    Route::post('/service/create', [SliderController::class, 'store']);
    Route::post('/service/update/{id}', [SliderController::class, 'update']);
    Route::post('/service/delete/{id}', [SliderController::class, 'destroy']);
